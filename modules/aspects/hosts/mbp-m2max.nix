...
{
  den.aspects.mbp-m2max.includes = with den.aspects; [
    workstation
    apple-silicon
  ];

  den.aspects.mbp-m2max.nixos =
    {
      lib,
      ...
    }:
    {
      imports = [ ../../../hosts/mbp-m2max/hardware-configuration.nix ];
  ...
  den.aspects.apple-silicon.nixos.imports = [
